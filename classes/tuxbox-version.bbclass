...
TUXBOX_IMAGE_FILE_SUFFIX ?= "${@'multi' if (bb.utils.contains('MACHINE_FEATURES', 'fastboot', True, False, d) or bb.utils.contains_any('IMAGE_CLASSES', d.getVar('TUXBOX_MULTI_IMAGE_SUFFIX_CLASSES') or '', True, False, d)) else 'usb'}"
