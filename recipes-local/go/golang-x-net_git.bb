...
SRC_URI = "\
	git://github.com/golang/net.git;protocol=https;name=net;destsuffix=${BPN}-${PV}/src/golang.org/x/net;branch=master \
	git://github.com/golang/crypto.git;protocol=https;name=crypto;destsuffix=${BPN}-${PV}/src/golang.org/x/crypto;branch=master \
	git://github.com/golang/text.git;protocol=https;name=text;destsuffix=${BPN}-${PV}/src/golang.org/x/text;branch=master \
	"
