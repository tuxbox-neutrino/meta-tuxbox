...
SRC_URI = "https://github.com/webmin/webmin/releases/download/${PV}/webmin-${PV}.tar.gz \
           file://setup.sh \
           file://webmin.service \
           file://0001-fix-authentic-theme-harden-sysinfo-parsing.patch \
           "

SRC_URI[md5sum] = "5b402ac8f00c0107128b2d0f21d779e9"
SRC_URI[sha256sum] = "88381e8bcdd4733b215c114ca2158dc044892ea68dc0da4d235d88d2b1db4bb8"

UPSTREAM_CHECK_URI = "https://api.github.com/repos/webmin/webmin/releases/latest"
UPSTREAM_CHECK_REGEX = "\"tag_name\": \"(?P<pver>[0-9]+(\.[0-9]+)+)\""
...
do_configure() {
    ...
    # Fix naming that causes problems at packaging time
    find . -name "*\**" | while read -r from
    do
